...
var planeMaterial = new THREE.MeshBasicMaterial({ color: 0xffdd77, side: THREE.FrontSide });
...
const keyDown = e => {
    switch (e.key) {
        ...
        case 'ArrowDown':
            ...
            break;
        case 'w':
            camera.position.applyAxisAngle(new THREE.Vector3(1, 0, 0), 0.1);
            break;
        case 'e':
            camera.position.applyAxisAngle(new THREE.Vector3(0, 1, 0), 0.1);
            break;
        case 'r':
            camera.position.applyAxisAngle(new THREE.Vector3(0, 0, 1), 0.1);
            break;
    }
}
